        ...
        <div className="grid md:grid-cols-2 gap-8 items-start">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center space-x-3">
              <a href="https://www.facebook.com/share/1HDKEeNsrB/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer" className="w-8 h-8 bg-black/50 border border-red-500/30 rounded-full flex items-center justify-center hover:border-red-500/50 transition-colors backdrop-blur-sm">
              ...
              <a href="https://www.instagram.com/codexpaceofficial?igsh=cHd5bHhjODI4NjE5" target="_blank" rel="noopener noreferrer" className="w-8 h-8 bg-black/50 border border-red-500/30 rounded-full flex items-center justify-center hover:border-red-500/50 transition-colors backdrop-blur-sm">
              ...
              <a href="https://www.linkedin.com/company/codexpaceofficial" target="_blank" rel="noopener noreferrer" className="w-8 h-8 bg-black/50 border border-red-500/30 rounded-full flex items-center justify-center hover:border-red-500/50 transition-colors backdrop-blur-sm">
